...
zeitgeber.sendCaptchaRequest=async(captchaAction,url,data)=>{const token=await grecaptcha.execute('6LfQhsEUAAAAAHDEZLdAba-Vv-x0VAQxBRGIlk16',{action:captchaAction});return await zeitgeber.sendHttpRequest('POST',url,{...data,captcha:token});}})();